...
public class ItemDarknessBow extends ItemMoreBow {
		...
		public static IIcon DarknessBow;
		public static IIcon DarknessBow1;
		public static IIcon DarknessBow2;
		public static IIcon DarknessBow3;
	    
	    
	public ItemDarknessBow(String info) {
		super(info);
		this.maxStackSize = 1;
	 ...
	 public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
	    {
	        ...
	        if (flag || p_77615_3_.inventory.hasItem(Items.arrow))
	        {
	            ...
	            if (!p_77615_2_.isRemote)
	            {
	                ...
	                entityarrow.getEntityData().setBoolean("MB2IsArrowBlinding", true);
	    ...
	    {
	        this.itemIcon = p_94581_1_.registerIcon("morebows2:" + "DarknessBow");
	        
	        
	        DarknessBow = p_94581_1_.registerIcon("morebows2:" + "DarknessBow");
	        DarknessBow1 = p_94581_1_.registerIcon("morebows2:" + "DarknessBow2");
	        DarknessBow2 = p_94581_1_.registerIcon("morebows2:" + "DarknessBow3");
	        DarknessBow3 = p_94581_1_.registerIcon("morebows2:" + "DarknessBow4");		
