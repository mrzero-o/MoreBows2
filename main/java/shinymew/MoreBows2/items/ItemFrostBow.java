...
public class ItemFrostBow extends ItemMoreBow {
	...
	public static IIcon FrostBow;
	public static IIcon FrostBow1;
	public static IIcon FrostBow2;
	public static IIcon FrostBow3;
    
    
public ItemFrostBow(String info) {
	super(info);
	this.maxStackSize = 1;
 ...
 public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        if (flag || p_77615_3_.inventory.hasItem(Items.arrow))
        {
            ...
            if (!p_77615_2_.isRemote)
            {
                ...
                entityarrow.getEntityData().setBoolean("MB2IsArrowFreezing", true);
    ...
    {
        this.itemIcon = p_94581_1_.registerIcon("morebows2:" + "FrostBow");
        
        
        FrostBow = p_94581_1_.registerIcon("morebows2:" + "FrostBow");
        FrostBow1 = p_94581_1_.registerIcon("morebows2:" + "FrostBow2");
        FrostBow2 = p_94581_1_.registerIcon("morebows2:" + "FrostBow3");
        FrostBow3 = p_94581_1_.registerIcon("morebows2:" + "FrostBow4");		
