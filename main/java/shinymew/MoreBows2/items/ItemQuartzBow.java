...
public class ItemQuartzBow extends ItemMoreBow {
		...
		public static IIcon QuartzBow;
		public static IIcon QuartzBow1;
		public static IIcon QuartzBow2;
		public static IIcon QuartzBow3;
	    
	    
	public ItemQuartzBow(String info) {
		super(info);
	 ...
	 public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
	    {
	        ...
	        if (flag || p_77615_3_.inventory.hasItem(Items.arrow))
	        {
	            ...
	            if (!p_77615_2_.isRemote)
	            {
	                ...
	                entityarrow.getEntityData().setBoolean("IsArrowWeak", true);
	    ...
	    {
	        this.itemIcon = p_94581_1_.registerIcon("morebows2:" + "QuartzBow");
	        
	        
	        QuartzBow = p_94581_1_.registerIcon("morebows2:" + "QuartzBow");
	        QuartzBow1 = p_94581_1_.registerIcon("morebows2:" + "QuartzBow2");
	        QuartzBow2 = p_94581_1_.registerIcon("morebows2:" + "QuartzBow3");
	        QuartzBow3 = p_94581_1_.registerIcon("morebows2:" + "QuartzBow4");		
