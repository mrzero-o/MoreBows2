...
public class ItemLapisBow extends ItemMoreBow {
	  ...
	  public static final String[] bowPullIconNameArray = new String[] {"pulling_0", "pulling_1", "pulling_2"};
		...
		public static IIcon LapisBow;
		public static IIcon LapisBow1;
		public static IIcon LapisBow2;
		public static IIcon LapisBow3;
	    
	    
	public ItemLapisBow(String info) {
		super(info);
		this.maxStackSize = 1;
	 ...
	 public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
	    {
	        ...
	        if (flag || p_77615_3_.inventory.hasItem(Items.arrow))
	        {
	            ...
	            if (!p_77615_2_.isRemote)
	            {
	                ...
	                entityarrow.setDamage(entityarrow.getDamage() * 1.7D);
	            }
	        }
	    }
	    ...
	    {
	        this.itemIcon = p_94581_1_.registerIcon("morebows2:" + "LapisBow");
	        
	        
	        LapisBow = p_94581_1_.registerIcon("morebows2:" + "LapisBow");
	        LapisBow1 = p_94581_1_.registerIcon("morebows2:" + "LapisBow2");
	        LapisBow2 = p_94581_1_.registerIcon("morebows2:" + "LapisBow3");
	        LapisBow3 = p_94581_1_.registerIcon("morebows2:" + "LapisBow4");		
