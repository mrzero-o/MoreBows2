...
public class ItemReinforcedBow extends ItemMoreBow {

	    @SideOnly(Side.CLIENT)
	    private IIcon[] iconArray;
	    private static final String __OBFID = "CL_00001777";
	    
		public static IIcon ReinforcedBow;
		public static IIcon ReinforcedBow1;
		public static IIcon ReinforcedBow2;
		public static IIcon ReinforcedBow3;
	    
	    
	public ItemReinforcedBow(String info) {
		super(info);
	 ...
	 public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
	    ...
	    {
	        this.itemIcon = p_94581_1_.registerIcon("morebows2:" + "ReinforcedBow");
	        
	        
	        ReinforcedBow = p_94581_1_.registerIcon("morebows2:" + "ReinforcedBow");
	        ReinforcedBow1 = p_94581_1_.registerIcon("morebows2:" + "ReinforcedBow2");
	        ReinforcedBow2 = p_94581_1_.registerIcon("morebows2:" + "ReinforcedBow3");
	        ReinforcedBow3 = p_94581_1_.registerIcon("morebows2:" + "ReinforcedBow4");		
		...
		{	
			...
			if (var8 >= 17)
			{		
				if(this == ModItems.ReinforcedBow)
				{
					return ReinforcedBow3;
				}
