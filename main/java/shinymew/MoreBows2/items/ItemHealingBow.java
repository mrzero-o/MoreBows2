...
public class ItemHealingBow extends ItemMoreBow {
	...
	public static IIcon HealingBow;
	public static IIcon HealingBow1;
	public static IIcon HealingBow2;
	public static IIcon HealingBow3;
    
    
public ItemHealingBow(String info) {
	super(info);
	this.maxStackSize = 1;
 ...
 public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        if (flag || p_77615_3_.inventory.hasItem(Items.arrow))
        {
            ...
            if (!p_77615_2_.isRemote)
            {
                ...
                entityarrow.getEntityData().setBoolean("MB2IsArrowHealing", true);
                entityarrow.setDamage(entityarrow.getDamage() * 0.0D);
    ...
    {
        this.itemIcon = p_94581_1_.registerIcon("morebows2:" + "HealingBow");
        
        
        HealingBow = p_94581_1_.registerIcon("morebows2:" + "HealingBow");
        HealingBow1 = p_94581_1_.registerIcon("morebows2:" + "HealingBow2");
        HealingBow2 = p_94581_1_.registerIcon("morebows2:" + "HealingBow3");
        HealingBow3 = p_94581_1_.registerIcon("morebows2:" + "HealingBow4");		
