...
public class ItemSacredBow extends ItemMoreBow {
		...
		public static IIcon SacredBow;
		public static IIcon SacredBow1;
		public static IIcon SacredBow2;
		public static IIcon SacredBow3;
	    
	    
	public ItemSacredBow(String info) {
		super(info);
	 ...
	 public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
	    {
	        ...
	        if (flag || p_77615_3_.inventory.hasItem(Items.arrow))
	        {
	            ...
	            if (!p_77615_2_.isRemote)
	            {
		            ...
		            entityarrow.getEntityData().setBoolean("MB2IsArrowSacred", true);
	                entityarrow.setDamage(entityarrow.getDamage() * 0.05D);
	            }
	        }
	    }
	    ...
	    {
	        this.itemIcon = p_94581_1_.registerIcon("morebows2:" + "SacredBow");
	        
	        
	        SacredBow = p_94581_1_.registerIcon("morebows2:" + "SacredBow");
	        SacredBow1 = p_94581_1_.registerIcon("morebows2:" + "SacredBow2");
	        SacredBow2 = p_94581_1_.registerIcon("morebows2:" + "SacredBow3");
	        SacredBow3 = p_94581_1_.registerIcon("morebows2:" + "SacredBow4");		
